      ...
      <div class="col-12">
        <div class="make-nav-stick">
          <div class="list-group d-block" id="list-tab">
            ...
            <?php } ?>
<?php if($has_ai_access) { ?>

<div class="row mt-3" id="list-ai-list">

  <div class="col-12">

    <h2 class="section-title"><?php echo $this->lang->line('AI APIs'); ?></h2>

    <p class="section-lead text-muted">

      <?php echo $this->lang->line('Integrate AI APIs for advanced conversation and analysis capabilities.'); ?>

    </p>

  </div>

  <?php foreach($ai_apis as $ai_api) : ?>

    <div class="col-4 col-lg-2">

      <a href="<?php echo $ai_api['action_url']; ?>" class="text-dark action_tag">
        ...
        <div class="wizard-steps mb-3">
          ...
          <div class="wizard-step mx-1 my-0">
            ...
            <div class="wizard-step-icon">
              ...
              <img class="img-fluid" width="80" src="<?php echo $ai_api['img_path']; ?>" alt="">

            </div>

            <div class="wizard-step-label"><?php echo $ai_api['title']; ?></div>
...
<div class="row mt-3" id="list-ai-models">
    ...
    <?php if (isset($ai_providers) && is_array($ai_providers)): // Check if $ai_providers exists and is an array ?>
        <?php foreach ($ai_providers as $provider): ?> 
            <div class="col-4 col-lg-2">
                <a href="<?php echo $provider['settings_url']; ?>" class="text-dark action_tag">
                    <div class="wizard-steps mb-3">
                        <div class="wizard-step mx-1 my-0">
                            <div class="wizard-step-icon">
                                <img class="img-fluid" width="80" src="<?php echo $provider['img_path']; ?>" alt="<?php echo $provider['name']; ?>">
                            </div>
                            <div class="wizard-step-label"><?php echo $provider['name']; ?></div>
                        </div>
                    </div>
                </a>
            </div>
